                    ...
                    <nav className="hidden lg:flex flex-row items-center gap-x-12">
                        <ul className="flex items-center gap-x-8 text-lg">
                            <li className="relative group">
                                <Link href="/browse-vocal" className="text-black">
                                    Browse Vocals
                                </Link>
                                <ul className="absolute left-0 top-full mt-0 hidden w-52 rounded-lg bg-white shadow-lg z-50 group-hover:block">
                                    <li className="p-4">
