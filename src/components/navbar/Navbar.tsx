    ...
    "
                  >
                    <li className="px-4 py-2 hover:bg-gray-100 text-center ">
                      <Link
                        className={`${pathname === "/vocals" ? "text-[#E7F056]" : "text-black"}`}
                        href="/vocals">
                        Vocals
                      </Link>
                    </li>
                    <li className="px-4 py-3 hover:bg-gray-100 text-center ">
                      <Link
                        className={` ${pathname === "/cover-vocals" ? "text-[#E7F056]" : "text-black"} `}
                        href="/cover-vocals">
                        Cover Vocals
                      </Link>
                    </li>
          ...
          <div
            ...
            <ul className="flex flex-col p-4 gap-4">
              ...
              <li>
                <Link
                  className={` -ml-1 ${pathname === "/cover-vocals" ? "text-[#E7F056]" : " text-black "}`}
                  href="/cover-vocals">
                  Cover Vocals
                </Link>
              </li>
