...
export function MusickPlayer({
    ...
    console.log('song_poster', currentTrack?.song_poster );
    console.log('song', currentTrack?.song );
    ...
    useEffect(() => {
        ...
        return () => {
            try {
                ...
                console.warn('Error stopping audio on cleanup:', err);
            }
            ws.destroy();
        };
    }, [currentTrack]);
    ...
    console.log("audio is",currentTrack.song)
