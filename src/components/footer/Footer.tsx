                    ...
                    <div className="  ">
                        ...
                        <div className="flex gap-x-5 justify-end mt-4">
                            <div className="  rounded-full">
                                <a target="_blank" href="https://www.instagram.com/accounts/login/?hl=en" ><FaInstagramSquare size={25} /></a>
                            </div>
                            <div className="  rounded-full">
                                <a target="_blank" href="https://www.instagram.com/accounts/login/?hl=en" ><FaTiktok size={25} /></a>
                            </div>
                            <div className="  rounded-full">
                                <a target="_blank" href="https://www.instagram.com/accounts/login/?hl=en" ><BsDiscord size={25} /></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-wrap gap-10">
                        <div>
                            <ul className="flex flex-col gap-1">
                                ...
                                <li><Link className="text-lg text-[#000000] leading-9" href="/tune-m-artist">Hire a Singer</Link></li>

                                <li><Link className="text-lg text-[#000000] leading-9" href="/https://tunemcollective.com/">Courses</Link></li>
                            </ul>
                        </div>
                        ...
                        <div>
                            <ul className="flex flex-col gap-1">
                                ...
                                <li><Link className="text-lg text-[#000000] leading-9" href="/privacy-policy">Privacy Policy</Link></li>
                            </ul>
                        </div>
