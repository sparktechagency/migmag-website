...
const LoginPage: React.FC = () => {
    ...
    return (
        <div className='  pb-10 lg:pb-[200px] '>
            <MaxWidth>
                <div style={{fontFamily: 'Decular'}}
                    ...
                    <div className=' max-w-[584px] bg-white p-6 rounded-3xl shadow-md mt-10 lg:mt-[113px] '>
                        <div>
                            <h1 style={{fontFamily: 'Decular'}}
                                className=' text-center headerColor text-2xl lg:text-[40px] font-stretch-semi-expanded font-semibold'>Welcome!</h1>
                            <p style={{fontFamily: 'Decular'}} className=' mt-2 textColor text-sm text-center '>Please
                                register with valid information for create account.</p>
                        </div>
                        <div className='lg:mt-16 mt-4 '>
                            ...
                            <div>
                                <p className=' text-center mt-6 textColor text-sm '>Don’t have an account? <Link
                                    className=' font-bold underline headerColor ' href={"/register"}>Register</Link></p>
                            </div>
                        </div>
                    </div>
                    <div>
