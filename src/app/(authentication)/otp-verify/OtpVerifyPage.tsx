...
const OtpVerifyPage: React.FC = () => {
    ...
    return (
        <div style={{fontFamily: 'Decular'}} className='   h-screen '>
            <MaxWidth>
                <div
                    ...
                    <div
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="flex justify-end mt-2">
                                <button className="headerColor cursor-pointer text-sm font-semibold">
                                    Send again
                                </button>
                            </div>
                            <button
                                type="submit"
                                className="w-full cursor-pointer bg-[#E7F056] headerColor text-lg font-semibold py-2 hover:bg-[#BEC645] rounded-lg mt-[10%] transition-all"
                            >
                                Verify OTP
                            </button>
                        </form>
