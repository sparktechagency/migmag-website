    ...
    return (
        <div>
            <div className={` hidden md:block  `} >
                <div className="flex items-center justify-between p-4 rounded-lg shadow-md  py-6  transition-colors duration-200 gap-1 md:gap-4">
                    {/* Left */}
                    ...
                    <div className="flex items-center gap-x-6 flex-1 justify-end min-w-0">
                        ...
                        <Link href={`/hire-from/${slug}`}>
                            <button className="text-white bg-[#FDC700] px-2  lg:px-4 lg:py-2 py-1 md:text-[16px] text-xs rounded-md cursor-pointer">
                                Hire Now
                            </button>
                        </Link>
                    </div>
            ...
            <div className={"md:hidden block   "} >
                <div className="flex items-center justify-between p-4   rounded-lg shadow-sm hover:shadow-md transition-shadow cursor-pointer">
                    <div className="flex items-center space-x-4">
                        <div className="overflow-hidden flex flex-row items-center space-x-4">
                            {/* Profile Image */}
                            <div>
                                <Link href={`/singer-profile/${slug}`} className="rounded-full">
                                    <Image
                                        src={`${imgUrl}/${profile}`}
                                        alt={name}
                                        width={64}
                            ...
                            <div className="flex items-center space-x-3">
                                ...
                                <button
                                    ...
                                    className="w-10 h-10 bg-gray-200 hover:bg-gray-300 cursor-pointer flex items-center justify-center rounded-full"
                                >
                                    {isPlaying ? "❚❚" : <FaPlay />}
                                </button>
                            </div>
                        ...
                        <div>
                            ...
                            <p className="text-black text-sm">{singer}</p>
                        </div>
                    </div>
