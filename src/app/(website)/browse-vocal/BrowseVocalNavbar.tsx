    ...
    return (
                    ...
                    <nav className="hidden lg:flex flex-row items-center gap-x-12">
                        <ul className="flex items-center gap-x-8 text-lg">
                            <li className="relative group">
                                ...
                                <ul className="absolute left-0 border border-gray-300 top-full mt-0 hidden w-52 rounded-lg bg-white shadow-lg z-50 group-hover:block">
                                    <li className="p-4">
        ...
        <span className="text-white">
          ...
          0
                        ...
                        <Link href="/login">
                            <button
                                className="bg-white text-black px-6 py-2 cursor-pointer rounded-full font-medium ">
                                Log in
                            </button>
                        </Link>
                    </nav>
