                        ...
                        <table className="w-full table-auto rounded-lg overflow-hidden">
                            <thead>
                                <tr className="text-white">
                                    ...
                                    <th className="py-3 lg:px-6 mt-10 mb-8 text-left text-[#E7F056] text-[10px] md:text-[16px]"></th>
                                    <th className="py-3 lg:px-6 mt-10 mb-8 text-left text-[#E7F056] text-[10px] md:text-[16px]">
                                    ...
                                    <th className="py-3 lg:px-6 mt-10 mb-8 text-center space-y-3 text-[#E7F056] text-[10px] md:text-[16px]">
                                    ...
                                    <th className="py-3 lg:px-6 mt-10 mb-8 text-center space-y-3  text-[#E7F056] text-[10px] md:text-[16px]">
                                        ...
                                        <div className="relative md:w-[157px] w-[120px] " ref={genderRef}>
                                            <button
                                                type="button"
                                                className="bg-[#201F1F]  relative  text-white px-5 py-3 rounded-2xl w-full text-left cursor-pointer flex items-center gap-2"
                                    ...
                                    <th className="py-3 lg:px-6 mt-10 mb-8 text-center text-[#E7F056] text-[10px]  space-y-3 md:text-[16px]">
                                        {/* License */}

                                        <div className="relative md:w-[157px] w-[120px]  " ref={licenseRef}>
                                            <button
                                                type="button"
                                                className="bg-[#201F1F]  relative  text-white px-5 py-3 rounded-2xl w-full text-left cursor-pointer flex items-center gap-2"
                            ...
                            <tbody className="w-full">
                                {filteredData.slice(0, visibleData).map((item, i) => (
                                    ...
                                    >
                                        ...
                                        <td className="lg:py-4 lg:px-6 px-3 w-full ">
                                            <h3 className="text-white lg:font-bold text-[10px] lg:text-xl md:text-sm">{item.title}</h3>
                                        </td>
                                        <td className="lg:py-4 lg:px-6 px-3">
                                            <p className="text-white lg:font-bold text-[10px] lg:text-xl">{item.artist}</p>
                                        </td>
                                        <td className="lg:py-4 py-1 px-2 lg:px-6 text-white lg:font-bold text-center text-[10px] lg:text-xl">{item.genre}</td>
                                        <td className="lg:py-4 py-1 px-2 lg:px-6 text-white lg:font-bold text-[10px] text-center lg:text-xl">{item.gender}</td>
                                        <td className="lg:py-4 w-[95%] py-1 px-2 lg:px-6 text-white md:text-sm text-[10px]">
                                            <h1
                                                className={`text-center rounded-2xl py-1 px-3
