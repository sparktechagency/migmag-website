        ...
        <div className="overflow-hidden whitespace-nowrap bg-[#E7F056] my-11 py-3">
            ...
            >
                <div className=" flex flex-row items-center gap-16 lg:gap-24 " >
                    ...
                    <div>
                        <button style={{ fontFamily: 'Favorit' }} ><button className=" cursor-pointer  text-[#000000] text-lg border border-[#000000] rounded-[17px] py-3 px-6 " >VIEW  OUR SINGERS</button></button>
                    </div>
                </div>
