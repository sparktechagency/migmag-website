            ...
            <div className=' lg:mt-14 mt-6 flex flex-col lg:flex-row justify-between '>
                ...
                <div className=' max-w-2xl text-white '>
                    <div style={{fontFamily: 'Bayon'}}
                         className=' max-w-[668px] lg:text-[80px] text-5xl lg:leading-20 '>
                        Get Studio Quality Acapellas
                    </div>
                    <div style={{fontFamily: 'Favorit'}}
                         className=' max-w-[561px] mt-3 lg:mt-6 text-lg leading-6 font-bold '>
                        <p>Spark new ideas today with our royalty free acapellas made by professional vocalists.Used by
                    ...
                    <div className=' flex gap-3.5 lg:gap-12 items-center mb-6 lg:mt-10 '>
                        ...
                        <div className='  lg:w-[90px] w-[50px] h-[50px] lg:h-[90px] rounded-full  '>
                            <Image src={"/images/ai-data-set/music.png"} alt={"Broadcasst"} width={100} height={100}
                                   className={`object-cover  `}/>
                        </div>
                        <div className='  lg:w-[90px] w-[50px] h-[50px] lg:h-[90px] rounded-full  '>
