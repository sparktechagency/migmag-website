...
const Page: React.FC = () => {
    ...
    "
                                ...
                                <li><Link className={`${pathname === "/hire" ? "text-[#E7F056]" : "text-white"}`}
                                          artist-library href="/hire">Hire</Link></li>
                            </ul>
            ...
            <div className='max-w-[1549px] mx-auto px-4'>
                <div className="max-w-[1539px] mx-auto">
                    ...
                    <div className="mx-auto flex justify-center">
                        <span>
                            <svg width="96" height="41" viewBox="0 0 96 41" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div>
                            ...
                            <div className="max-w-[478px] mt-4">
                                <p className="text-lg leading-6 text-[#FFFFFF]">
                                    Our newsletter is published every month and contains lots of inspiration and updates
                                    from music life at TUNEM.
                                </p>
                            </div>
                            <div className="mt-6">
                                <Link href="/register">
                        ...
                        <div className="  ">
                            <div className="max-w-[478px]">
                                <p className=" text-[#FFFFFF] text-end text-lg leading-6">
                                    Vocalfy boosts your career with the best vocals. We have unique and special singers,
                                    top song-writers, producers and professional recording studios to ensure you get the
                        ...
                        <div className="flex flex-wrap gap-10">
                            <div>
                                <ul className="flex flex-col gap-1">
                                    ...
                                    <li><Link className="text-lg text-white leading-9" href="/tune-m-artist">Hire a
                                        Singer</Link></li>
                            ...
                            <div>
                                <ul className="flex flex-col gap-1">
                                    ...
                                    <li><Link className="text-lg text-white leading-9" href="/contact">Contact Us</Link>
                                    </li>
                                    ...
                                    <li><Link className="text-lg text-[#ffffff] leading-9" href="term&condiction">Term &
                                        Condiction</Link></li>
                                    <li><Link className="text-lg text-[#ffffff] leading-9" href="/privacy-policy">Privacy
                                        Policy</Link></li>

                                    <li><Link className="text-lg text-[#fff] leading-9" href="/license">License</Link>
                                    </li>
                                </ul>
                            </div>
