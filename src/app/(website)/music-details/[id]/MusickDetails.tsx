    ...
    return (
        <>
            ...
            <div className="w-full max-w-6xl mx-auto bg-white rounded-md p-4 shadow-md relative">
                {/* Top Right Icons */}
                <div className="absolute   top-4 right-4 flex gap-4 text-gray-400">
                ...
                <div className="flex gap-4">
                    {/* Left - Image */}
                    <div className="relative w-36 h-64 border max-w-2xl border-black rounded-md overflow-hidden">
                        <Image
            ...
            {showModal && (
                <div className="fixed top-1/2 left-1/2 z-50 transform -translate-x-1/2 -translate-y-1/2 bg-white rounded-lg shadow-md px-6 py-5 w-[95%] max-w-md">
                    {/* Close Button */}
                    <button onClick={() => setShowModal(false)} className="absolute top-3 right-4 text-gray-400 hover:text-black">
                        <X size={18} />
                    </button>
