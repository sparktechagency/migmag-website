...
const Page: React.FC = () => {
    ...
    "
        ...
        <span className="text-white">
          {/* Cart Icon SVG */}
            <FaCartArrowDown className={` text-[#E7F056] `}/>
        </span>
                                            <span
          ...
          0
                ...
                <MaxWidth>
                    <div style={{fontFamily: 'Favorit'}} className=' mx-auto  mt-8 lg:mt-14  '>
                        ...
                        <div
                            className=' text-white font-bold lg:text-lg ml-2 mt-5 md:mt-8 lg:mt-20 leading-6 max-w-[605px] '>
                            <p>Whether you&apos re an established artist or waiting for your big break, Voclio is for
                                you.
                                Save time Easy and clear overview over your projects. Seamless payments to you. No fee.
                                Instant payouts.
                            </p>
                        ...
                        <div className=' mt-5 md:mt-8 lg:mt-16'>
                            <Link
                                className=' border border-[#FFFFFF] rounded-[17px] px-4 py-3 text-white text-sm  cursor-pointer '
                                href={"/contact"}>APPLY NOW</Link>
                        </div>
                    </div>
                </MaxWidth>
