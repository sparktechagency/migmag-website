                ...
                >
                    ...
                    <div className="relative z-10">
                        ...
                        <div className="mx-auto mt-5 lg:mt-16">
                            <h1 style={{ fontFamily: 'Favorit' }} className="text-center lg:text-7xl text-3xl text-white font-thin">
                                GROW YOUR <br />
                                REACH & AUDIENCE
                            </h1>
                        </div>
                        ...
                        <div>
                            <button className="text-[#E7F056]   px-4 py-1 border border-white rounded-2xl block mx-auto mt-4 lg:mt-13">
