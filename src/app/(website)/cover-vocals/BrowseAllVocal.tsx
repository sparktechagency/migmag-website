        ...
        <>
            <MaxWidth>
                <div className="  mx-auto   ">
                    ...
                    <div
                        className=" lg:hidden     my-4 space-y-4   max-w-[1539px]  mx-auto   mb-6  ">


                        {/* BPM */}

                        <div className="relative   " ref={bpmRef}>
                            <button
                                type="button"
                            ...
                            <AnimatePresence>
                                {openBPM && (
                                    ...
                                    >
                                        <div
                                            ref={bpmRef}
                                            className="bg-[#201F1F]  rounded-2xl p-6 w-full lg:w-[25%]  max-h-[80vh] overflow-auto"
                                        >
