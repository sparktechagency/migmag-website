                    ...
                    <clipPath id="clip0_1_2039">
                      <rect width="96" height="41" fill="white"/>
                            ...
                            <div className="mt-12 flex flex-col lg:flex-row justify-between gap-10">
                                <div>
                                    <h1 className="font-bold text-3xl lg:text-[35px] leading-9 text-[#FFFFFF]">Sign-up
                                        to our newsletter</h1>
                                    <div className="max-w-[478px] mt-4">
                                        <p className="text-lg leading-6 text-[#FFFFFF]">
                                            Our newsletter is published every month and contains lots of inspiration and
                                            updates from music life at TUNEM.
                                        </p>
                                        <div>
                                ...
                                <div className="  ">
                                    <div className="max-w-[478px]">
                                        <p className=" text-[#FFFFFF] text-end text-lg leading-6">
                                            Vocalfy boosts your career with the best vocals. We have unique and special
                                            singers, top song-writers, producers and professional recording studios to
                                            ensure you get the vocal you’ve been looking for.
                                        </p>
                                    </div>
                            ...
                            <div className="mt-7 hidden pb-20  lg:flex flex-col md:flex-row justify-between gap-10">
                                <div>
                                    ...
                                    <div className="flex items-center  mt-2 gap-4">
                                            ...
                                            <svg width="80" height="100" viewBox="0 0 24 16" fill="none"
                                                ...
                                                <g clipPath="url(#clip0_181783_2033)">
                                                    <path
                                                        ...
                                                        fill="white" stroke="black" strokeOpacity="0.2"
                                                        strokeWidth="0.5"/>
                                                    <path
                                        ...
                                        <div className="  rounded-full">
                                            <FaCcApplePay className={"text-white"} size={65}/>
                                    ...
                                    <div className={`mt-16`}>
                                        ...
                                        <div>
                                            ...
                                            >
                                                <FaFacebook
                                                    size={30}
                                                    className="text-white hover:text-[#E7F056] transition-all cursor-pointer"
                                                />
                                ...
                                <div className="flex flex-wrap gap-10">
                                    ...
                                    <div>
                                        <ul className="flex flex-col gap-1">
                                            ...
                                            <li><Link className="text-lg text-[#ffffff] leading-9"
                                                      href="/term&condiction">Term & Condiction</Link></li>
                                            <li><Link className="text-lg text-[#ffffff] leading-9"
                                                      href="/privacy-policy">Privacy Policy</Link></li>

                                            <li><Link className="text-lg text-[#fff] leading-9"
                                                      href="/license">License</Link></li>
                                        </ul>
                                    </div>
                            ...
                            <div className="mt-7 pb-20 lg:hidden flex justify-between gap-10">
                                <div>
                                    ...
                                    <div className="flex items-center  mt-2 gap-4">
                                        ...
                                        <div className="  rounded-full">
                                            <FaCcApplePay className={"text-white"} size={40}/>
