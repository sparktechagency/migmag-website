    ...
    return (
        <div className=' max-w-[1539px] mx-auto px-4 mt-20   '>
            ...
            <div style={{fontFamily: 'Favorit'}}
                ...
                <div>
                    <div className=' flex flex-col lg:flex-row items-center lg:gap-x-16 '>
                        ...
                        {/* description  */}
                        <div>
                            <h1 className=' text-xl mt-3 lg:mt-0 lg:text-2xl text-[#000000] leading-9 '>Ethan</h1>
                            <div className='lg:mt-3 mt-1.5 text-white text-xl lg:space-x-4 space-x-3 '>
                                <button
                                    className=' bg-[#818080] cursor-pointer px-4 py-1 rounded-2xl lg:text-lg text-sm '>SINGER
                                </button>
                                <button
                                    className=' bg-[#818080] cursor-pointer px-6 py-1 rounded-2xl lg:text-lg text-sm '>SONGWRITER
                                </button>
                            </div>
                ...
                <div className={`'>`}>
                    ...
                    <div className=' mt-8 lg:mt-[75px] flex justify-center gap-x-3.5 space-y-3 lg:space-y-6 '>
                        <button style={{fontFamily: 'Degular'}}
                                className=' flex cursor-pointer  items-center gap-x-2 lg:gap-x-3 text-sm lg:text-lg  lg:px-4 px-3.5 py-1 lg:py-1 border border-black rounded-2xl '>
                            <span><svg width="27" height="27" viewBox="0 0 27 27" fill="none"
            ...
            <div style={{fontFamily: 'Favorit'}} className="max-w-[1539px] mx-auto px-4  pt-4 lg:pt-10">
                ...
                {/*                        />*/}
                {/*                        <div*/}
                {/*                            className="absolute inset-0 m-auto w-8 h-8 border-2 border-yellow-400 rounded-full flex items-center justify-center">*/}
                ...
                {/*                    </button>*/}
                {/*                    <span*/}
                {/*                        className={`flex justify-center items-center ${licenseColorsText[track.license]}`}>*/}
                {/*                            <svg width="26" height="26" viewBox="0 0 26 26" fill="none"*/}
                {/*                                 xmlns="http://www.w3.org/2000/svg">*/}
                {/*                                <path*/}
                {/*                                    d="M11.64 16V13.66C11.64 12.28 12.22 11.76 13.64 11.76H13.86C15.06 11.76 15.84 10.98 15.84 9.78C15.84 8.56 15.04 7.8 13.66 7.8H9.7V6H13.96C16.24 6 17.8 7.5 17.8 9.78C17.8 12 16 13.46 14.24 13.46C13.74 13.46 13.54 13.66 13.54 14.16V16H11.64ZM11.54 20V17.8H13.64V20H11.54Z"*/}
                {/*                                    fill="#818080"/>*/}
                ...
                {/*                                    <button*/}
                {/*                                        className=' bg-white cursor-pointer text-black text-lg font-medium text-center px-4 rounded-full '> Add*/}
                {/*                                        to cart*/}
                {/*                                    </button>*/}
                {/*                                </> : <button*/}
                {/*                                    className=' bg-[#E7F056] cursor-pointer px-4 rounded-full py-0.5 '>€{track.price}</button>*/}
                {/*                            }*/}
            ...
            <div style={{fontFamily: 'Favorit'}} className='px-4  '>
                ...
                <div className=' mt-7 '>
                    <p className=' leading-6 text-[#818080] text-lg '>*all vocals are royalty free, both non-exclusive
                ...
                <div className=' flex flex-col lg:flex-row space-y-2.5 justify-between items-center mt-4 '>
                    ...
                    <Link href={""} className=' '>
                        <button
                            className=' flex cursor-pointer  items-center gap-x-5 rounded-2xl px-7 py-1.5 border border-black text-lg  '>
                            BROWSE SINGERS
                        </button>
                    </Link>
                </div>
            ...
            <div style={{fontFamily: 'Favorit'}}
                ...
                {/*        <Link href="">*/}
                {/*            <button*/}
                {/*                className="flex items-center  rounded-2xl px-7 py-1.5 border border-black lg:text-lg cursor-pointer">*/}
                {/*                BROWSE SINGERS*/}
                {/*            </button>*/}
                {/*        </Link>*/}
                {/*    </div>*/}
                ...
                {/*        <Link href="/contact">*/}
                {/*            <button*/}
                {/*                className="flex items-center gap-x-5 rounded-2xl px-7 py-1.5 border border-black lg:text-lg cursor-pointer">*/}
                {/*                CONTACT US*/}
                {/*            </button>*/}
                {/*        </Link>*/}
                {/*    </div>*/}
            ...
            <div style={{fontFamily: 'Favorit'}} className=' mt-16 px-4 '>
                ...
                <div
                    ...
                    <div>
                        <p className=' lg:rotate-90 text-[#000000] lg:text-lg lg:absolute lg:top-14 lg:-ml-20  '>JUST
                            FOR YOU</p>
                    </div>
                    {/* left side  */}
                    <div>
                    ...
                    <div>
                        ...
                        <div className=' max-w-[478px] lg:mt-8 mt-3 '>
                            <h1 className=' lg:text-lg text-[#000000] leading-6 font-thin '>
                                WET mixed vocals (with fx), Multiple DRY Vocal Takes and Lyrics PDF. All files in 24bit
                                WAV.
                            </h1>
                        </div>
                        ...
                        <div className="max-w-[700px] mx-auto lg:mt-[50px] mt-7  space-y-6 ">
                            ...
                            <div className=' lg:ml-14 -mt-4 '>
                                ...
                                <div className=" transition duration-300 w-full ">
                                    <p className="text-[#000000] font-bold lg:text-xl mb-4">Multiple DRY Vocal Takes</p>
                                    <p className="text-[#000000] font-light mt-4 lg:text-lg leading-7">
                            ...
                            <div className=' lg:ml-14 -mt-4 '>
                                ...
                                <div className=" transition duration-300 w-full ">
                                    <p className="text-[#000000] font-bold lg:text-xl mb-4">Lyrics PDF</p>
                                    <p className="text-[#000000] font-light mt-4 lg:text-lg leading-7">
