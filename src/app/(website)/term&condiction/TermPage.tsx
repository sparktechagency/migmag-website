...
const TermPage : React.FC = () => {
    return (
        <div style={{fontFamily:"Favorit"}} className="  lg:py-10 px-4  text-[#000000] ">
            <div className="max-w-7xl mx-auto bg-white  rounded-lg p-8">
                <h1 className="text-3xl font-bold mb-6 text-center">TuneM Terms and Conditions</h1>

                <p className="mb-4">
                    Welcome to TuneM! These terms and conditions outline the rules and regulations for the use of the TuneM website,
                    located at <a href="https://www.tunem.ai" className="text-blue-600 underline">www.tunem.ai</a>.
                </p>
                <p className="mb-6">
                    By accessing this website we assume you accept these terms and conditions in full.
                    Do not continue to use TuneM if you do not accept all of the terms and conditions stated on this page.
                </p>
                ...
                <p className="text-sm text-gray-600 mt-8">
                    By using TuneM, you acknowledge that you have read, understood, and agreed to these Terms and Conditions.
                </p>
            </div>
        </div>
    );
