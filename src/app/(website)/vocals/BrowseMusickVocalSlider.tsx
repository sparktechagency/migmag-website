      ...
      <MaxWidth>
        ...
        <div className="relative">
          ...
          <button
            ...
            aria-label="Previous"
            className={`absolute left-0 top-[42%] cursor-pointer -translate-y-1/2 z-20 p-2 bg-white bg-opacity-60 rounded-full text-black hover:bg-opacity-90 transition ${currentSlide === 0 ? 'opacity-30 cursor-not-allowed' : ''
              }`}
          >
            ...
            <div className="flex gap-x-3  " style={{ width: `${tracks.length * slideWidth}px` }}>
              {tracks.map((item, index) => (
                ...
                >
                  ...
                  <h3 className="lg:text-lg text-white  font-bold mt-3">{item?.title.slice(0, 15)}...</h3>
