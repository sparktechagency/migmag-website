...
const NonExclusiveLicense = () => {
    return (
        <div style={{ fontFamily: "Favorit" }} >
            ...
            >
                <h2 className="lg:text-4xl text-2xl font-bold">Non-Exclusive License</h2>
                <p className="text-gray-600 text-sm lg:text-lg">From $34</p>

                <h3 className="lg:text-2xl text-lg font-semibold">Full license:</h3>
                <p className=' lg:text-lg text-sm ' >
                    This Agreement is made effective as of the date of the purchase between the purchaser (“You” “Licensee”) and Vocalfy LLC.
                </p>

                <section>
                    <h4 className="lg:text-2xl text-lg font-semibold mb-2">A. Delivery</h4>
                ...
                <section>
                    <h4 className="lg:text-2xl text-lg font-bold mb-2">B. Use of the vocal track</h4>
                    <p className=' lg:text-lg text-sm ' >
                ...
                <section>
                    <h4 className="lg:text-2xl text-lg font-bold mb-2">C. General terms</h4>
                    <ul className="list-disc lg:text-lg list-inside text-sm space-y-2">
                ...
                <section>
                    ...
                    <ul className=" lg:text-lg text-sm list-disc list-inside space-y-2">
                ...
                <section>
                    <h4 className=" lg:text-2xl text-lg font-bold mb-2">F. Stem Files & Midi Files</h4>
                    <p className=' lg:text-lg text-sm ' >
                ...
                <section>
                    <h4 className="lg:text-2xl text-lg font-bold mb-2">G. Violation of Agreement</h4>
                    <p className=' lg:text-lg text-sm ' >
...
export default NonExclusiveLicense;
