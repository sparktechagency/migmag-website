                        ...
                        <div
                            ...
                            <ul className="flex flex-col p-4 gap-4">
                                <li>
                                    <Link
                                        href="/browse-vocal"
                                        className={` ${pathname === "/browse-vocal" ? " " : "text-black"}`}
                                    >
                                        Vocals
                                    </Link>
                                ...
                                <li>
                                    <Link
                                        href="/cover-vocals"
                                        className={` ${pathname === "/cover-vocals" ? " " : "text-black"}`}
                                    >
                                        Cover vocals
                                    </Link>
                                </li>
                                <li><Link
                                    className={` ${pathname === "/artist-library" ? " " : "text-black"}`}
                                    href="/artist-library">Artists</Link></li>
                                <li><Link className={` ${pathname === "/hire" ? " " : "text-black"}`}
                                          href="/hire">Hire</Link></li>
                                <li><Link className=' text-white ' href="/cart">Cart (0)</Link></li>
                                <li  >
                                    <Link href={"/login"}>
                                        <button
                                            className="bg-white cursor-pointer text-gray-300 px-6 py-2 rounded-full w-full">
                                            Login
                                        </button>
                                    </Link>
                                </li>
