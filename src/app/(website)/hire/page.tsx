        ...
        <span className="text-white">
                ...
                <Link href="/">
                  <svg width="174" height="22" viewBox="0 0 174 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g clipPath="url(#clip0_5_567)">
                      <path d="M76.7524 9.06705H68.8925V21.7686H64.7479V9.06705H56.8997V5.57196H76.7524V9.06705Z"
                            fill="black"/>
                      <path
         ...
         '>
                        ...
                        <div style={{fontFamily: 'Favorit'}}
                             className=' text-white font-bold text-lg ml-2 mt-10 lg:mt-20 leading-6 max-w-[600px] '>
                            <p>
                                Choose from a diverse roster of professional singers across multiple languages and
                                styles.
                                Select your vocalist, share your idea, and receive a custom-recorded vocal tailored
                                to your track delivered with high-quality stems

                            </p>
                        </div>
                        <div style={{fontFamily: 'Favorit'}} className='mt-16'>
                            <Link className=' border border-[#FFFFFF] rounded-[17px] px-3 py-3 text-white text-[14px]  '
                                  href={"/artist-library"}>
                                BROWSE OUR SINGERS
                            </Link>
                        </div>
