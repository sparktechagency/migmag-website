                            ...
                            <Link href="/">
                                <svg width="174" height="22" viewBox="0 0 174 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g clipPath="url(#clip0_37_102)">
                                        <path d="M76.7524 9.06705H68.8924V21.7686H64.7478V9.06705H56.8997V5.57196H76.7524V9.06705Z" fill="black" />
                                        <path d="M88.8755 22.003C81.7705 22.003 78.7183 19.2971 78.7183 13.651V5.57196H82.8629V13.648C82.8629 15.9148 83.4846 18.5049 88.8637 18.5049C94.2428 18.5049 94.8675 15.8911 94.8675 13.648V5.57196H99.0121V13.648C99.0358 19.2704 95.9628 22.003 88.8755 22.003Z" fill="black" />
                                        ...
                                        <path d="M168.162 21.7686H164.017V10.6633L157.3 21.7686H154.298L147.581 10.6633V21.7686H143.437V5.57196H149.061L155.826 17.0007L162.591 5.57196H168.215L168.162 21.7686Z" fill="black" />
                            ...
                            <nav className="hidden lg:flex flex-row items-center gap-x-12">
                                <ul className="flex items-center gap-x-8 text-lg">
                                    <li className="relative group">
                                        {/* parent link */}
                                        <span className={`text-black`}>Vocals</span>
    ...
    "
                                        >
                                            <li className="px-4 py-2 hover:bg-gray-100 text-center ">
                                                <Link className="text-black text-center " href="/browse-vocal">
                                                    Vocals
                                                </Link>
                                            </li>
                                            <li className="px-4 py-2 hover:bg-gray-100 text-center ">
                                                <Link className="text-black text-center " href="/cover-vocals">
                                                    Cover Vocals
                                                </Link>
                                            </li>
                                    ...
                                    <li><Link className="text-black" href="/artist-library">Artists</Link>
                                    </li>
                                    <li><Link
                                        className={` ${pathname === "/hire" ? " " : "text-black"}`}
                        ...
                        <div
                            ...
                            <ul className="flex flex-col p-4 gap-4">
                                <li>
                                    <Link
                                        href="/browse-vocal"
                                        className={` ${pathname === "/browse-vocal" ? " " : "text-white"}`}
                                    >
                                        Vocals
                                    </Link>
                                ...
                                <li>
                                    <Link
                                        href="/cover-vocals"
                                        className={` ${pathname === "/cover-vocals" ? " " : "text-white"}`}
                                    >
                                        Cover vocals
                                    </Link>
                                </li>
                                <li><Link
                                    className={` ${pathname === "/artist-library" ? " " : "text-white"}`}
                                    href="/artist-library">Artists</Link></li>
                                <li><Link className={` ${pathname === "/hire" ? " text-white " : "text-white"}`}
                                    href="/hire">Hire</Link></li>
                                <li><Link className=' text-white ' href="/cart">Cart (0)</Link></li>
                                <li  >
                                    <Link href={"/login"}>
                                        <button
                                            className="bg-white cursor-pointer text-black px-6 py-2 rounded-full w-full">
                                            Login
                                        </button>
                                    </Link>
                                </li>
