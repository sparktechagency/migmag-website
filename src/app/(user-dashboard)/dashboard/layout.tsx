        ...
        <div className=' bg-[#222222] z-50 ' >
            <main className="w-full bg-[#222222]  min-h-screen relative">
                        ...
                        <Link href="/">
                            <svg width="174" height="22" viewBox="0 0 174 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g clipPath="url(#clip0_1_390)">
                                    <path d="M76.7521 9.06699H68.8922V21.7685H64.7475V9.06699H56.8994V5.5719H76.7521V9.06699Z" fill="white" />
                                    <path d="M88.8751 22.0029C81.77 22.0029 78.7178 19.297 78.7178 13.6509V5.5719H82.8624V13.648C82.8624 15.9147 83.4841 18.5049 88.8632 18.5049C94.2423 18.5049 94.867 15.891 94.867 13.648V5.5719H99.0116V13.648C99.0353 19.2704 95.9623 22.0029 88.8751 22.0029Z" fill="white" />
                                    ...
                                    <path d="M168.162 21.7685H164.017V10.6632L157.3 21.7685H154.298L147.581 10.6632V21.7685H143.437V5.5719H149.061L155.826 17.0006L162.591 5.5719H168.215L168.162 21.7685Z" fill="white" />
                ...
                <div className="2xl:flex 2xl:gap-x-20 ">
                    ...
                    <div style={{ fontFamily: 'Favorit' }} className="w-full p-8  mt-[95px]">
                        {children}
                    </div>
                </div>
