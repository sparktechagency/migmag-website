      ...
      <MaxWidth>
        <div className='  mx-auto  mt-10 lg:mt-[91px]   '>
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-5 mt-8 lg:mt-2 w-full">
            {/* Left Side */}
            <div className="bg-black p-5 rounded-md w-full lg:max-w-[411px]">
              ...
              <div className="mt-7 lg:mt-[50px] space-y-3 lg:space-y-12 max-w-[700px]">
                {/* Feature 1 */}
            ...
            <div className="w-full lg:w-[70%] h-auto  ">
              <Image
                ...
                width={1200}
                height={800}
                className="h-[85vh]  w-full  object-cover rounded-lg"
              />
            </div>
          </div>
