          ...
          <div className=" lg:-mt-1 mt-4   ">
            ...
            <div className=" maw-w-[450px] lg:mt-8 mt-3 ">
              <h1 className=" lg:text-lg leading-6 textColor ">
                Connect your Spotify or Apple Music, and we’ll show you relevant
                events based on your favourite artists - Whether you&apos;re
                uploading to Spotify, Apple Music, Beatport, or YouTube all
